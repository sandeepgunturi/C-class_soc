...
//
// On Fri Oct  9 13:14:10 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mk_csr_daisy(CLK,
  ...
  wire [31 : 0] mv_mcounteren, mv_pmp_cfg;
  ...
  reg [1 : 0] mk_grp1_mav_upd_on_ret_prv;
  wire [144 : 0] mk_grp1_mv_csrs_to_decode;
  ...
  wire [4 : 0] mk_grp1_ma_update_fflags_flags;
  ...
  wire mk_grp1_EN_ma_clint_msip,
       ...
       mk_grp1_EN_ma_set_seip,
       mk_grp1_EN_ma_update_fflags,
  ...
  wire [31 : 0] mk_grp2_mv_pmp_cfg;
  wire [2 : 0] mk_grp2_mv_cacheenable;
  ...
  reg [1 : 0] CASE_mk_grp1mv_csrs_to_decode_BITS_144_TO_143_ETC__q1,
	      CASE_mk_grp1mv_mpp_1_mk_grp1mv_mpp_3_mk_grp1_ETC__q2;
  wire [63 : 0] anydata__h944,
		x__h2460,
		x__h2462,
		x__h2464,
		x__h2466,
  ...
  wire [15 : 0] x__h2852;
  wire [11 : 0] x__h2812;
  wire IF_rg_prv_EQ_3_OR_rg_prv_EQ_1_THEN_rg_prv_ELSE_ETC___d107,
       mk_grp1_mv_core_resp__0_BIT_64_1_OR_mk_grp2_mv_ETC___d69,
       mk_grp1_mv_medeleg__01_SRL_mav_upd_on_trap_c_B_ETC___d105,
       mk_grp1_mv_mideleg__5_SRL_mav_upd_on_trap_c_BI_ETC___d100,
       y__h2849;
  ...
  assign mv_csrs_to_decode =
	     { CASE_mk_grp1mv_csrs_to_decode_BITS_144_TO_143_ETC__q1,
	       mk_grp1_mv_csrs_to_decode[142:0] } ;
  ...
  begin
    case (rg_prv)
      2'd1, 2'd3: mv_curr_priv = rg_prv;
      default: mv_curr_priv = 2'd0;
    endcase
  end
  ...
  mk_csr_grp1 mk_grp1(.CLK(CLK),
		      ...
		      .ma_set_seip_ex_i(mk_grp1_ma_set_seip_ex_i),
		      .ma_upd_privilege_prv(mk_grp1_ma_upd_privilege_prv),
		      .ma_update_fflags_flags(mk_grp1_ma_update_fflags_flags),
  ...
  assign MUX_rg_prv_write_1__VAL_1 =
	     (mav_upd_on_ret_prv == 2'd1) ?
	       (mk_grp1_mv_spp ? 2'd1 : 2'd0) :
	       CASE_mk_grp1mv_mpp_1_mk_grp1mv_mpp_3_mk_grp1_ETC__q2 ;
  assign MUX_rg_prv_write_1__VAL_2 =
	     ((mk_grp1_mv_mideleg__5_SRL_mav_upd_on_trap_c_BI_ETC___d100 ||
	       mk_grp1_mv_medeleg__01_SRL_mav_upd_on_trap_c_B_ETC___d105) &&
	      IF_rg_prv_EQ_3_OR_rg_prv_EQ_1_THEN_rg_prv_ELSE_ETC___d107 &&
  ...
  assign mk_grp1_ma_set_seip_ex_i = ma_set_seip_ex_i ;
  assign mk_grp1_ma_upd_privilege_prv = mv_curr_priv ;
  assign mk_grp1_ma_update_fflags_flags = ma_update_fflags_flags ;
  always@(mav_upd_on_ret_prv)
  begin
    case (mav_upd_on_ret_prv)
      2'd1, 2'd3: mk_grp1_mav_upd_on_ret_prv = mav_upd_on_ret_prv;
      default: mk_grp1_mav_upd_on_ret_prv = 2'd0;
    endcase
  end
  ...
  assign mk_grp1_EN_ma_counter_interrupts =
	     CAN_FIRE_RL_rl_send_counter_interrupts ;
  assign mk_grp1_EN_ma_update_fflags = EN_ma_update_fflags ;
  ...
  assign mk_grp1_EN_ma_set_seip = EN_ma_set_seip ;
  ...
  assign mk_grp3_ma_upd_privilege_prv = mv_curr_priv ;
  ...
  // remaining internal signals
  assign IF_rg_prv_EQ_3_OR_rg_prv_EQ_1_THEN_rg_prv_ELSE_ETC___d107 =
	     mv_curr_priv <= 2'd1 ;
  assign anydata__h944 = x__h2460 | mk_grp7_mv_core_resp[63:0] ;
  assign mk_grp1_mv_core_resp__0_BIT_64_1_OR_mk_grp2_mv_ETC___d69 =
  ...
  assign mk_grp1_mv_medeleg__01_SRL_mav_upd_on_trap_c_B_ETC___d105 =
	     x__h2852[0] & y__h2849 ;
  assign mk_grp1_mv_mideleg__5_SRL_mav_upd_on_trap_c_BI_ETC___d100 =
	     x__h2812[0] & mav_upd_on_trap_c[5] ;
  assign x__h2460 = x__h2462 | mk_grp6_mv_core_resp[63:0] ;
  assign x__h2462 = x__h2464 | mk_grp5_mv_core_resp[63:0] ;
  assign x__h2464 = x__h2466 | mk_grp4_mv_core_resp[63:0] ;
  assign x__h2466 = x__h2468 | mk_grp3_mv_core_resp[63:0] ;
  assign x__h2468 = mk_grp1_mv_core_resp[63:0] | mk_grp2_mv_core_resp[63:0] ;
  assign x__h2812 = mk_grp1_mv_mideleg >> mav_upd_on_trap_c[4:0] ;
  assign x__h2852 = mk_grp1_mv_medeleg >> mav_upd_on_trap_c[4:0] ;
  assign y__h2849 = ~mav_upd_on_trap_c[5] ;
  always@(mk_grp1_mv_csrs_to_decode)
  begin
    case (mk_grp1_mv_csrs_to_decode[144:143])
      2'd1, 2'd3:
	  CASE_mk_grp1mv_csrs_to_decode_BITS_144_TO_143_ETC__q1 =
	      mk_grp1_mv_csrs_to_decode[144:143];
      default: CASE_mk_grp1mv_csrs_to_decode_BITS_144_TO_143_ETC__q1 = 2'd0;
    endcase
  end
  always@(mk_grp1_mv_mpp)
  begin
    case (mk_grp1_mv_mpp)
      2'd1, 2'd3:
	  CASE_mk_grp1mv_mpp_1_mk_grp1mv_mpp_3_mk_grp1_ETC__q2 =
	      mk_grp1_mv_mpp;
      default: CASE_mk_grp1mv_mpp_1_mk_grp1mv_mpp_3_mk_grp1_ETC__q2 = 2'd0;
    endcase
  end
