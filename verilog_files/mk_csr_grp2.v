...
//
// On Fri Oct  9 13:13:54 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mk_csr_grp2(CLK,
  ...
  wire [63 : 0] x__h2894, x__h3659, x__h7087, x__h7109;
  wire [3 : 0] x__h2768;
  wire [2 : 0] r1__read__h2781;
  wire [1 : 0] r1__read_BITS_1_TO_0___h7505, r1__read__h2783;
  ...
  // value method mv_cacheenable
  assign mv_cacheenable = { r1__read_BITS_1_TO_0___h7505, rg_ienable } ;
  ...
  always@(ma_core_req_req or
	  ...
	  x__h3659 or
	  v_pmp_addr_0 or
	  v_pmp_addr_1 or v_pmp_addr_2 or v_pmp_addr_3 or x__h2768)
  begin
    case (ma_core_req_req[79:68])
      ...
      12'h3A0: rg_resp_to_core_1_wget = { 1'd1, x__h3659 };
      12'h3A2,
      12'h3B4,
      12'h3B5,
      12'h3B6,
      ...
      12'h800: rg_resp_to_core_1_wget = { 61'h1000000000000000, x__h2768 };
  ...
  assign csr_op_arg_wget =
	     { ma_core_req_req[67:4],
	       ...
	       ma_core_req_req[3:2] } ;
  always@(ma_core_req_req or x__h7109)
  begin
    case (ma_core_req_req[79:68])
      12'h301, 12'h340, 12'h3A0, 12'h3A2, 12'h3B0, 12'h3B1, 12'h3B2, 12'h3B3:
	  csr_op_res_wget = x__h7109;
      default: csr_op_res_wget = x__h7109;
    endcase
  end
  ...
  // register v_pmp_addr_0
  assign v_pmp_addr_0_D_IN = csr_op_res_wget ;
  assign v_pmp_addr_0_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h3B0 &&
	     !v_pmp_cfg_0[7] ;

  // register v_pmp_addr_1
  assign v_pmp_addr_1_D_IN = csr_op_res_wget ;
  assign v_pmp_addr_1_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h3B1 &&
	     !v_pmp_cfg_1[7] ;

  // register v_pmp_addr_2
  assign v_pmp_addr_2_D_IN = csr_op_res_wget ;
  assign v_pmp_addr_2_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h3B2 &&
	     !v_pmp_cfg_2[7] ;

  // register v_pmp_addr_3
  assign v_pmp_addr_3_D_IN = csr_op_res_wget ;
  assign v_pmp_addr_3_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h3B3 &&
	     !v_pmp_cfg_3[7] ;

  // register v_pmp_cfg_0
  assign v_pmp_cfg_0_D_IN = csr_op_res_wget[7:0] ;
  assign v_pmp_cfg_0_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h3A0 &&
	     !v_pmp_cfg_0[7] &&
	     csr_op_res_wget[1:0] != 2'b10 &&
	     csr_op_res_wget[4:3] != 2'd2 ;

  // register v_pmp_cfg_1
  assign v_pmp_cfg_1_D_IN = csr_op_res_wget[15:8] ;
  assign v_pmp_cfg_1_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h3A0 &&
	     !v_pmp_cfg_1[7] &&
	     csr_op_res_wget[9:8] != 2'b10 &&
	     csr_op_res_wget[12:11] != 2'd2 ;

  // register v_pmp_cfg_2
  assign v_pmp_cfg_2_D_IN = csr_op_res_wget[23:16] ;
  assign v_pmp_cfg_2_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h3A0 &&
	     !v_pmp_cfg_2[7] &&
	     csr_op_res_wget[17:16] != 2'b10 &&
	     csr_op_res_wget[20:19] != 2'd2 ;

  // register v_pmp_cfg_3
  assign v_pmp_cfg_3_D_IN = csr_op_res_wget[31:24] ;
  assign v_pmp_cfg_3_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h3A0 &&
	     !v_pmp_cfg_3[7] &&
	     csr_op_res_wget[25:24] != 2'b10 &&
	     csr_op_res_wget[28:27] != 2'd2 ;
  ...
  module_fn_csr_op instance_fn_csr_op_0(.fn_csr_op_writedata(csr_op_arg_wget[129:66]),
					...
					.fn_csr_op(x__h7109));
  assign r1__read_BITS_1_TO_0___h7505 = { rg_bpuenable, rg_denable } ;
  assign r1__read__h2781 = { r1__read__h2783, rg_denable } ;
  assign r1__read__h2783 = { 1'd0, rg_bpuenable } ;
  assign x__h2768 = { r1__read__h2781, rg_ienable } ;
  assign x__h2894 =
	     { 43'h40000000000,
	       rg_misa_u,
	       1'd0,
  ...
  assign x__h7087 = { 60'd0, x__h2768 } ;
  always@(ma_core_req_req or
	  x__h7087 or
	  rg_sscratch or
	  x__h2894 or
