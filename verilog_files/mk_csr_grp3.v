...
//
// On Fri Oct  9 13:13:56 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mk_csr_grp3(CLK,
  ...
  wire [63 : 0] x__h2083;
  wire [31 : 0] x__h1199;
  wire [30 : 0] r1__read__h1212;
  wire [29 : 0] r1__read__h1214;
  ...
  // register rg_mhpminterrupten
  assign rg_mhpminterrupten_D_IN = v__h1475[31:0] ;
  ...
  module_fn_csr_op instance_fn_csr_op_0(.fn_csr_op_writedata(csr_op_arg_wget[129:66]),
					...
					.fn_csr_op(x__h2083));
  assign r1__read__h1212 = { r1__read__h1214, 1'd0 } ;
  assign r1__read__h1214 = { rg_hpm_enabler, rg_ir } ;
  assign x__h1199 = { r1__read__h1212, rg_cy } ;
  ...
  always@(ma_core_req_req or rg_mhpminterrupten or rg_mcounteren or x__h1199)
  begin
    case (ma_core_req_req[79:68])
      12'h306:
	  CASE_ma_core_req_req_BITS_79_TO_68_0x306_rg_mc_ETC__q2 =
	      rg_mcounteren;
      12'h320:
	  CASE_ma_core_req_req_BITS_79_TO_68_0x306_rg_mc_ETC__q2 = x__h1199;
  ...
  always@(ma_core_req_req or x__h2083)
  begin
    case (ma_core_req_req[79:68])
      12'h306, 12'hB00, 12'hB02: v__h1475 = x__h2083;
      default: v__h1475 = x__h2083;
    endcase
  end
