...
//
// On Fri Oct  9 13:14:07 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mk_csr_grp7(CLK,
  ...
  reg [63 : 0] IF_ma_core_req_req_BITS_79_TO_68_35_EQ_0xB18_3_ETC___d230;
  wire [63 : 0] x__h8120;
  wire [30 : 0] bs__h4439;
  ...
  wire NOT_mhpmevent_0_EQ_0_0_1_AND_mhpmcounter_0_2_E_ETC___d21,
       ...
       mhpmevent_7_20_EQ_0_21_OR_NOT_mhpmcounter_7_22_ETC___d130,
       x__h3401,
       x__h3555,
       x__h3702,
       x__h3849,
  ...
  always@(ma_core_req_req or x__h8120)
  begin
    case (ma_core_req_req[79:68])
      ...
      12'hB1E,
      12'hB1F:
	  MUX_mhpmcounter_0_write_1__VAL_1 = x__h8120;
      default: MUX_mhpmcounter_0_write_1__VAL_1 = x__h8120;
    endcase
  end
  assign MUX_mhpmcounter_0_write_1__VAL_2 =
	     mhpmcounter_0 + { 63'd0, x__h3401 } ;
  assign MUX_mhpmcounter_1_write_1__VAL_2 =
	     mhpmcounter_1 + { 63'd0, x__h3555 } ;
  assign MUX_mhpmcounter_2_write_1__VAL_2 =
	     mhpmcounter_2 + { 63'd0, x__h3702 } ;
  assign MUX_mhpmcounter_3_write_1__VAL_2 =
	     mhpmcounter_3 + { 63'd0, x__h3849 } ;
  assign MUX_mhpmcounter_4_write_1__VAL_2 =
	     mhpmcounter_4 + { 63'd0, x__h3996 } ;
  assign MUX_mhpmcounter_5_write_1__VAL_2 =
	     mhpmcounter_5 + { 63'd0, x__h4143 } ;
  assign MUX_mhpmcounter_6_write_1__VAL_2 =
	     mhpmcounter_6 + { 63'd0, x__h4290 } ;
  ...
  assign csr_op_arg_wget =
	     { ma_core_req_req[67:4],
	       IF_ma_core_req_req_BITS_79_TO_68_35_EQ_0xB18_3_ETC___d230,
	       ma_core_req_req[3:2] } ;
  ...
  assign bs__h4439 = { ma_events_e, 1'b0 } ;
  ...
  assign mhpmevent_6_05_EQ_0_06_OR_NOT_mhpmcounter_6_07_ETC___d115 =
	     ...
	     ma_mcountinhibit_mcountinhibit_val[6] ||
	     !ma_mhpminterrupten_v[6] ;
  assign mhpmevent_7_20_EQ_0_21_OR_NOT_mhpmcounter_7_22_ETC___d130 =
	     mhpmevent_7 == 64'd0 || mhpmcounter_7 != 64'd0 ||
	     ma_mcountinhibit_mcountinhibit_val[7] ||
	     !ma_mhpminterrupten_v[7] ;
  assign x__h3401 = bs__h4439[mhpmevent_0[4:0]] ;
  assign x__h3555 = bs__h4439[mhpmevent_1[4:0]] ;
  assign x__h3702 = bs__h4439[mhpmevent_2[4:0]] ;
  assign x__h3849 = bs__h4439[mhpmevent_3[4:0]] ;
  assign x__h3996 = bs__h4439[mhpmevent_4[4:0]] ;
  assign x__h4143 = bs__h4439[mhpmevent_5[4:0]] ;
  assign x__h4290 = bs__h4439[mhpmevent_6[4:0]] ;
  assign x__h4436 = bs__h4439[mhpmevent_7[4:0]] ;
  always@(ma_core_req_req or
	  mhpmevent_7 or
	  mhpmevent_0 or
	  mhpmevent_1 or
  ...
  begin
    case (ma_core_req_req[79:68])
	  ...
	  IF_ma_core_req_req_BITS_79_TO_68_35_EQ_0xB18_3_ETC___d230 =
	      mhpmcounter_7;
      default: IF_ma_core_req_req_BITS_79_TO_68_35_EQ_0xB18_3_ETC___d230 =
		   mhpmevent_7;
    endcase
  end
