...
//
// On Fri Oct  9 13:12:41 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkcombo_mul(CLK,
  ...
  wire [63 : 0] IF_rg_fn3_BITS_1_TO_0_EQ_0_THEN_signed_mul_oc__ETC___d13,
		default_out__h906,
		mv_output_data__h1336;
  wire [31 : 0] IF_rg_fn3_BITS_1_TO_0_EQ_0_THEN_signed_mul_oc__ETC__q1;
  wire sign1__h1040, sign2__h1041;
  ...
  // value method mv_output
  assign mv_output = { mv_output_data__h1336, rg_valid_0, 5'd0 } ;
  ...
  // register rg_op1_0
  assign rg_op1_0_D_IN = { sign1__h1040 & ma_inputs_in1[63], ma_inputs_in1 } ;
  assign rg_op1_0_EN = EN_ma_inputs ;

  // register rg_op2_0
  assign rg_op2_0_D_IN = { sign2__h1041 & ma_inputs_in2[63], ma_inputs_in2 } ;
  ...
  // remaining internal signals
  assign IF_rg_fn3_BITS_1_TO_0_EQ_0_THEN_signed_mul_oc__ETC___d13 =
	     (rg_fn3[1:0] == 2'd0) ?
	       signed_mul_c[63:0] :
	       signed_mul_c[127:64] ;
  assign IF_rg_fn3_BITS_1_TO_0_EQ_0_THEN_signed_mul_oc__ETC__q1 =
	     IF_rg_fn3_BITS_1_TO_0_EQ_0_THEN_signed_mul_oc__ETC___d13[31:0] ;
  assign default_out__h906 =
	     { {32{IF_rg_fn3_BITS_1_TO_0_EQ_0_THEN_signed_mul_oc__ETC__q1[31]}},
	       IF_rg_fn3_BITS_1_TO_0_EQ_0_THEN_signed_mul_oc__ETC__q1 } ;
  assign mv_output_data__h1336 =
	     rg_word ?
	       default_out__h906 :
	       IF_rg_fn3_BITS_1_TO_0_EQ_0_THEN_signed_mul_oc__ETC___d13 ;
  assign sign1__h1040 = ma_inputs_funct3[1] ^ ma_inputs_funct3[0] ;
  assign sign2__h1041 = ma_inputs_funct3[1:0] == 2'd1 ;
