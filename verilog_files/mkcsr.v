...
//
// On Fri Oct  9 13:14:14 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkcsr(CLK,
  ...
  reg [1 : 0] csrfile_mav_upd_on_ret_prv;
  ...
  reg [1 : 0] CASE_csrfilemv_csrs_to_decode_BITS_144_TO_143_ETC__q1;
  ...
  assign mv_csrs_to_decode =
	     { CASE_csrfilemv_csrs_to_decode_BITS_144_TO_143_ETC__q1,
	       csrfile_mv_csrs_to_decode[142:0] } ;
  ...
  always@(system_instruction_csr_address)
  begin
    case (system_instruction_csr_address[9:8])
      2'd1, 2'd3:
	  csrfile_mav_upd_on_ret_prv = system_instruction_csr_address[9:8];
      default: csrfile_mav_upd_on_ret_prv = 2'd0;
    endcase
  end
  ...
  // remaining internal signals
  always@(csrfile_mv_csrs_to_decode)
  begin
    case (csrfile_mv_csrs_to_decode[144:143])
      2'd1, 2'd3:
	  CASE_csrfilemv_csrs_to_decode_BITS_144_TO_143_ETC__q1 =
	      csrfile_mv_csrs_to_decode[144:143];
      default: CASE_csrfilemv_csrs_to_decode_BITS_144_TO_143_ETC__q1 = 2'd0;
    endcase
  end
