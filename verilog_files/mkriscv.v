...
//
// On Fri Oct  9 13:14:28 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkriscv(resetpc,
  ...
  wire [63 : 0] mv_csr_mstatus, mv_csr_satp;
  ...
  wire [99 : 0] pipe2_meta_D_IN, pipe2_meta_D_OUT;
  wire pipe2_meta_CLR,
       pipe2_meta_DEQ,
       pipe2_meta_EMPTY_N,
       pipe2_meta_ENQ,
  ...
  wire [141 : 0] stage0_ma_train_bpu_td;
  wire [76 : 0] stage0_tx_to_stage1_enq_data;
  ...
  wire [118 : 0] stage1_tx_to_stage2_enq_data;
  wire [76 : 0] stage1_rx_from_stage0_first_x;
  ...
  wire [144 : 0] stage2_csrs_csr;
  wire [118 : 0] stage2_rx_from_stage1_first_x;
  wire [99 : 0] stage2_tx_meta_to_stage3_enq_data;
  wire [71 : 0] stage2_mv_op2;
  wire [70 : 0] stage2_mv_op1;
  wire [69 : 0] stage2_commit_rd_commit, stage2_mv_op3;
  wire [63 : 0] stage2_tx_mtval_to_stage3_enq_data;
  ...
  wire [141 : 0] stage3_mv_train_bpu;
  wire [99 : 0] stage3_rx_meta_from_stage2_first_x;
  ...
  wire [144 : 0] stage5_mv_csrs_to_decode;
  ...
  reg [4 : 0] rd__h10760;
  reg [2 : 0] CASE_IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2__ETC__q9,
	      CASE_IF_pipe3type_notEmpty__33_THEN_IF_pipe3ty_ETC__q10,
	      CASE_stage2mv_op2_BITS_2_TO_0_0_stage2mv_op2_ETC__q8,
	      CASE_stage2tx_meta_to_stage3_enq_data_BITS_28_ETC__q2,
	      CASE_stage3tx_type_to_stage4_enq_data_BITS_3__ETC__q4,
	      IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2_meta__ETC___d134,
	      IF_pipe3type_notEmpty__33_THEN_IF_pipe3type_fi_ETC___d250;
  reg [1 : 0] CASE_stage2mv_op1_BITS_1_TO_0_0_stage2mv_op1_ETC__q7,
	      CASE_stage3tx_type_to_stage4_enq_data_BITS_82_ETC__q3,
	      CASE_stage4tx_min_enq_data_fst_BITS_135_TO_13_ETC__q5,
	      CASE_stage5dump_get_BITS_167_TO_166_1_stage5_ETC__q1,
	      CASE_stage5mv_csrs_to_decode_BITS_144_TO_143__ETC__q6;
  wire [63 : 0] _theResult___snd_snd_snd__h10875, fl_pc__h10201;
  ...
  wire [4 : 0] _theResult___fst__h10808;
  wire NOT_IF_pipe4_first__06_BITS_136_TO_135_07_EQ_2_ETC___d399,
       lv_count_dtlb_misses__h2927,
       lv_count_itlb_misses__h2926;
  ...
  // submodule pipe1
  FIFO2 #(.width(32'd119), .guarded(32'd1)) pipe1(.RST(RST_N),
						  .CLK(CLK),
						  .D_IN(pipe1_D_IN),
						  .ENQ(pipe1_ENQ),
						  .DEQ(pipe1_DEQ),
  ...
  // submodule pipe1inst
  FIFO2 #(.width(32'd32), .guarded(32'd1)) pipe1inst(.RST(RST_N),
						     .CLK(CLK),
						     .D_IN(pipe1inst_D_IN),
						     .ENQ(pipe1inst_ENQ),
						     .DEQ(pipe1inst_DEQ),
  ...
  FIFOL1 #(.width(32'd100)) pipe2_meta(.RST(RST_N),
				       .CLK(CLK),
  ...
  FIFO2 #(.width(32'd71), .guarded(32'd1)) pipe3common(.RST(RST_N),
						       .CLK(CLK),
  ...
  // submodule pipe3inst
  FIFO2 #(.width(32'd96), .guarded(32'd1)) pipe3inst(.RST(RST_N),
						     .CLK(CLK),
						     .D_IN(pipe3inst_D_IN),
						     .ENQ(pipe3inst_ENQ),
						     .DEQ(pipe3inst_DEQ),
  ...
  // submodule pipe3type
  FIFO2 #(.width(32'd83), .guarded(32'd1)) pipe3type(.RST(RST_N),
						     .CLK(CLK),
						     .D_IN(pipe3type_D_IN),
						     .ENQ(pipe3type_ENQ),
						     .DEQ(pipe3type_DEQ),
  ...
  mkstage5 #(.hartid(hartid)) stage5(.CLK(CLK),
				     ...
				     .ma_set_seip_ex_i(stage5_ma_set_seip_ex_i),
				     ...
				     .EN_ma_set_seip(stage5_EN_ma_set_seip),
  ...
  assign MUX_stage3_fwd_from_pipe4_first_1__VAL_1 =
	     { NOT_IF_pipe4_first__06_BITS_136_TO_135_07_EQ_2_ETC___d399,
		 ...
		 { _theResult___fst__h10808,
		   _theResult___snd_snd_snd__h10875,
  ...
  // submodule pipe2_meta
  assign pipe2_meta_D_IN =
	     { stage2_tx_meta_to_stage3_enq_data[99:29],
	       CASE_stage2tx_meta_to_stage3_enq_data_BITS_28_ETC__q2,
	       stage2_tx_meta_to_stage3_enq_data[25:0] } ;
  ...
  // submodule pipe3type
  assign pipe3type_D_IN =
	     { CASE_stage3tx_type_to_stage4_enq_data_BITS_82_ETC__q3,
	       (stage3_tx_type_to_stage4_enq_data[82:81] == 2'd0) ?
		 { 77'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */ ,
		   CASE_stage3tx_type_to_stage4_enq_data_BITS_3__ETC__q4,
		   stage3_tx_type_to_stage4_enq_data[0] } :
		 stage3_tx_type_to_stage4_enq_data[80:0] } ;
  ...
  assign pipe4_D_IN =
	     { CASE_stage4tx_min_enq_data_fst_BITS_135_TO_13_ETC__q5,
	       stage4_tx_min_enq_data_fst[133:0],
	       stage4_tx_min_enq_data_snd } ;
  ...
  assign stage2_csrs_csr =
	     { CASE_stage5mv_csrs_to_decode_BITS_144_TO_143__ETC__q6,
	       stage5_mv_csrs_to_decode[142:0] } ;
  ...
  assign stage3_fwd_from_pipe4_first_fwd =
	     pipe4_EMPTY_N ?
	       MUX_stage3_fwd_from_pipe4_first_1__VAL_1 :
	       MUX_stage3_fwd_from_pipe4_first_1__VAL_2 ;
  assign stage3_ma_op1_i =
	     { stage2_mv_op1[70:2],
	       CASE_stage2mv_op1_BITS_1_TO_0_0_stage2mv_op1_ETC__q7 } ;
  assign stage3_ma_op2_i =
	     { stage2_mv_op2[71:3],
	       CASE_stage2mv_op2_BITS_2_TO_0_0_stage2mv_op2_ETC__q8 } ;
  assign stage3_ma_op3_i = stage2_mv_op3 ;
  assign stage3_next_pc_npc = pipe1_D_OUT[118:55] ;
  ...
  assign stage3_rx_meta_from_stage2_first_x =
	     { pipe2_meta_D_OUT[99:29],
	       CASE_IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2__ETC__q9,
	       pipe2_meta_D_OUT[25:0] } ;
  ...
  assign stage4_rx_type_from_stage3_first_x =
	     (pipe3type_EMPTY_N && pipe3type_D_OUT[82:81] == 2'd0) ?
	       { 2'd0,
		 77'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */ ,
		 CASE_IF_pipe3type_notEmpty__33_THEN_IF_pipe3ty_ETC__q10,
		 pipe3type_D_OUT[0] } :
	       { (pipe3type_EMPTY_N && pipe3type_D_OUT[82:81] == 2'd1) ?
		   2'd1 :
		   ((pipe3type_EMPTY_N && pipe3type_D_OUT[82:81] == 2'd2) ?
		      2'd2 :
		      2'd3),
		 pipe3type_D_OUT[80:0] } ;
  ...
  assign stage5_ma_set_seip_ex_i = ma_set_seip_ex_i ;
  assign stage5_rx_in_first_deq_rdy_b = pipe4_EMPTY_N ;
  assign stage5_rx_in_first_x =
	     { (pipe4_EMPTY_N && pipe4_D_OUT[136:135] == 2'd0) ?
		 { 2'd0, pipe4_D_OUT[134:1] } :
		 ((pipe4_EMPTY_N && pipe4_D_OUT[136:135] == 2'd1) ?
		    { 2'd1, pipe4_D_OUT[134:1] } :
		    ((pipe4_EMPTY_N && pipe4_D_OUT[136:135] == 2'd2) ?
		       { 2'd2, pipe4_D_OUT[134:1] } :
		       { 2'd3,
  ...
  assign stage5_EN_ma_set_seip = EN_ma_set_seip ;
  ...
  assign NOT_IF_pipe4_first__06_BITS_136_TO_135_07_EQ_2_ETC___d399 =
	     (rd__h10760 != 5'd0 ||
	      ((pipe4_D_OUT[136:135] == 2'd2) ?
		 pipe4_D_OUT[1] :
		 pipe4_D_OUT[136:135] != 2'd1)) &&
	     pipe4_D_OUT[0] == rg_wEpoch ;
  assign _theResult___fst__h10808 =
	     (pipe4_D_OUT[136:135] == 2'd1) ? pipe4_D_OUT[5:1] : 5'd0 ;
  assign _theResult___snd_snd_snd__h10875 =
	     (pipe4_D_OUT[136:135] == 2'd1) ? pipe4_D_OUT[69:6] : 64'd0 ;
  assign fl_pc__h10201 =
	     stage5_flush_fst ?
	       stage5_flush_snd_fst :
	       stage3_flush_from_exe_snd ;
  assign lv_count_dtlb_misses__h2927 =
	     EN_ma_dtlb_counters && ma_dtlb_counters_i ;
  assign lv_count_itlb_misses__h2926 =
  ...
  always@(stage5_dump_get)
  begin
    case (stage5_dump_get[167:166])
      2'd1, 2'd3:
	  CASE_stage5dump_get_BITS_167_TO_166_1_stage5_ETC__q1 =
	      stage5_dump_get[167:166];
      default: CASE_stage5dump_get_BITS_167_TO_166_1_stage5_ETC__q1 = 2'd0;
    endcase
  end
  always@(pipe4_D_OUT)
  begin
    case (pipe4_D_OUT[136:135])
      2'd1: rd__h10760 = pipe4_D_OUT[5:1];
      2'd2: rd__h10760 = pipe4_D_OUT[11:7];
      default: rd__h10760 = 5'd0;
    endcase
  end
  always@(pipe2_meta_D_OUT)
  begin
    case (pipe2_meta_D_OUT[28:26])
      3'd0, 3'd1:
	  IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2_meta__ETC___d134 =
	      pipe2_meta_D_OUT[28:26];
      3'd2: IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2_meta__ETC___d134 = 3'd4;
      3'd3: IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2_meta__ETC___d134 = 3'd2;
      3'd4: IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2_meta__ETC___d134 = 3'd3;
      default: IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2_meta__ETC___d134 =
		   3'd5;
    endcase
  end
  always@(pipe3type_D_OUT)
  begin
    case (pipe3type_D_OUT[3:1])
      3'd0, 3'd1:
	  IF_pipe3type_notEmpty__33_THEN_IF_pipe3type_fi_ETC___d250 =
	      pipe3type_D_OUT[3:1];
      3'd2: IF_pipe3type_notEmpty__33_THEN_IF_pipe3type_fi_ETC___d250 = 3'd4;
      3'd3: IF_pipe3type_notEmpty__33_THEN_IF_pipe3type_fi_ETC___d250 = 3'd2;
      3'd4: IF_pipe3type_notEmpty__33_THEN_IF_pipe3type_fi_ETC___d250 = 3'd3;
      default: IF_pipe3type_notEmpty__33_THEN_IF_pipe3type_fi_ETC___d250 =
		   3'd5;
    endcase
  end
  always@(stage2_tx_meta_to_stage3_enq_data)
  begin
    case (stage2_tx_meta_to_stage3_enq_data[28:26])
      3'd0, 3'd1, 3'd2, 3'd3, 3'd4:
	  CASE_stage2tx_meta_to_stage3_enq_data_BITS_28_ETC__q2 =
	      stage2_tx_meta_to_stage3_enq_data[28:26];
      default: CASE_stage2tx_meta_to_stage3_enq_data_BITS_28_ETC__q2 = 3'd5;
    endcase
  end
  always@(stage3_tx_type_to_stage4_enq_data)
  begin
    case (stage3_tx_type_to_stage4_enq_data[82:81])
      2'd0, 2'd1, 2'd2:
	  CASE_stage3tx_type_to_stage4_enq_data_BITS_82_ETC__q3 =
	      stage3_tx_type_to_stage4_enq_data[82:81];
      2'd3: CASE_stage3tx_type_to_stage4_enq_data_BITS_82_ETC__q3 = 2'd3;
    endcase
  end
  always@(stage3_tx_type_to_stage4_enq_data)
  begin
    case (stage3_tx_type_to_stage4_enq_data[3:1])
      3'd0, 3'd1, 3'd2, 3'd3, 3'd4:
	  CASE_stage3tx_type_to_stage4_enq_data_BITS_3__ETC__q4 =
	      stage3_tx_type_to_stage4_enq_data[3:1];
      default: CASE_stage3tx_type_to_stage4_enq_data_BITS_3__ETC__q4 = 3'd5;
    endcase
  end
  always@(stage4_tx_min_enq_data_fst)
  begin
    case (stage4_tx_min_enq_data_fst[135:134])
      2'd0, 2'd1, 2'd2:
	  CASE_stage4tx_min_enq_data_fst_BITS_135_TO_13_ETC__q5 =
	      stage4_tx_min_enq_data_fst[135:134];
      2'd3: CASE_stage4tx_min_enq_data_fst_BITS_135_TO_13_ETC__q5 = 2'd3;
    endcase
  end
  always@(stage5_mv_csrs_to_decode)
  begin
    case (stage5_mv_csrs_to_decode[144:143])
      2'd1, 2'd3:
	  CASE_stage5mv_csrs_to_decode_BITS_144_TO_143__ETC__q6 =
	      stage5_mv_csrs_to_decode[144:143];
      default: CASE_stage5mv_csrs_to_decode_BITS_144_TO_143__ETC__q6 = 2'd0;
    endcase
  end
  always@(stage2_mv_op1)
  begin
    case (stage2_mv_op1[1:0])
      2'd0, 2'd2:
	  CASE_stage2mv_op1_BITS_1_TO_0_0_stage2mv_op1_ETC__q7 =
	      stage2_mv_op1[1:0];
      default: CASE_stage2mv_op1_BITS_1_TO_0_0_stage2mv_op1_ETC__q7 = 2'd1;
    endcase
  end
  always@(stage2_mv_op2)
  begin
    case (stage2_mv_op2[2:0])
      3'd0, 3'd1, 3'd2, 3'd4:
	  CASE_stage2mv_op2_BITS_2_TO_0_0_stage2mv_op2_ETC__q8 =
	      stage2_mv_op2[2:0];
      default: CASE_stage2mv_op2_BITS_2_TO_0_0_stage2mv_op2_ETC__q8 = 3'd3;
    endcase
  end
  always@(IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2_meta__ETC___d134)
  begin
    case (IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2_meta__ETC___d134)
      3'd0, 3'd1:
	  CASE_IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2__ETC__q9 =
	      IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2_meta__ETC___d134;
      3'd2: CASE_IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2__ETC__q9 = 3'd3;
      3'd3: CASE_IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2__ETC__q9 = 3'd4;
      3'd4: CASE_IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2__ETC__q9 = 3'd2;
      default: CASE_IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2__ETC__q9 = 3'd5;
    endcase
  end
  always@(IF_pipe3type_notEmpty__33_THEN_IF_pipe3type_fi_ETC___d250)
  begin
    case (IF_pipe3type_notEmpty__33_THEN_IF_pipe3type_fi_ETC___d250)
      3'd0, 3'd1:
	  CASE_IF_pipe3type_notEmpty__33_THEN_IF_pipe3ty_ETC__q10 =
	      IF_pipe3type_notEmpty__33_THEN_IF_pipe3type_fi_ETC___d250;
      3'd2: CASE_IF_pipe3type_notEmpty__33_THEN_IF_pipe3ty_ETC__q10 = 3'd3;
      3'd3: CASE_IF_pipe3type_notEmpty__33_THEN_IF_pipe3ty_ETC__q10 = 3'd4;
      3'd4: CASE_IF_pipe3type_notEmpty__33_THEN_IF_pipe3ty_ETC__q10 = 3'd2;
      default: CASE_IF_pipe3type_notEmpty__33_THEN_IF_pipe3ty_ETC__q10 = 3'd5;
    endcase
  end
