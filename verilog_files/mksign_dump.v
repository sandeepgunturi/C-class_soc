...
//
// On Fri Oct  9 13:16:07 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mksign_dump(CLK,
  ...
  FIFO2 #(.width(32'd52), .guarded(32'd1)) m_xactor_f_rd_addr(.RST(RST_N),
							      .CLK(CLK),
  ...
  FIFO2 #(.width(32'd71), .guarded(32'd1)) m_xactor_f_rd_data(.RST(RST_N),
							      .CLK(CLK),
  ...
  FIFO2 #(.width(32'd52), .guarded(32'd1)) m_xactor_f_wr_addr(.RST(RST_N),
							      .CLK(CLK),
  ...
  FIFO2 #(.width(32'd77), .guarded(32'd1)) m_xactor_f_wr_data(.RST(RST_N),
							      .CLK(CLK),
  ...
  FIFO2 #(.width(32'd6), .guarded(32'd1)) m_xactor_f_wr_resp(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd52), .guarded(32'd1)) s_xactor_f_rd_addr(.RST(RST_N),
							      .CLK(CLK),
  ...
  FIFO2 #(.width(32'd71), .guarded(32'd1)) s_xactor_f_rd_data(.RST(RST_N),
							      .CLK(CLK),
  ...
  FIFO2 #(.width(32'd52), .guarded(32'd1)) s_xactor_f_wr_addr(.RST(RST_N),
							      .CLK(CLK),
  ...
  FIFO2 #(.width(32'd77), .guarded(32'd1)) s_xactor_f_wr_data(.RST(RST_N),
							      .CLK(CLK),
  ...
  FIFO2 #(.width(32'd6), .guarded(32'd1)) s_xactor_f_wr_resp(.RST(RST_N),
							     .CLK(CLK),
  ...
  // remaining internal signals
  assign lv_shift__h2522 = { ff_lower_order_bits_D_OUT, 3'd0 } ;
  assign m_xactor_f_rd_dataD_OUT_BITS_68_TO_5_SRL_lv_s_ETC__q3 =
	     m_xactor_f_rd_data_D_OUT[68:5] >> lv_shift__h2522 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response &&
	  m_xactor_f_rd_data_D_OUT[70:69] != 2'd0)
	$display(v__h2764, "\tSIGNATUREDUMP got Bus Error");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response &&
	  m_xactor_f_rd_data_D_OUT[70:69] != 2'd0)
	$finish(32'd0);
