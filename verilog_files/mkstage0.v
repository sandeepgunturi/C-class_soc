...
//
// On Fri Oct  9 13:11:51 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkstage0(resetpc,
  ...
  reg [63 : 0] v__h2995;
  reg TASK_testplusargs_6_OR_TASK_testplusargs_7_AND_ETC___d44;
  reg TASK_testplusargs_6_OR_TASK_testplusargs_7_AND_ETC___d47;
  reg TASK_testplusargs_6_OR_TASK_testplusargs_7_AND_ETC___d49;
  reg TASK_testplusargs_6_OR_TASK_testplusargs_7_AND_ETC___d52;
  reg TASK_testplusargs_6_OR_TASK_testplusargs_7_AND_ETC___d55;
  reg TASK_testplusargs_6_OR_TASK_testplusargs_7_AND_ETC___d57;
  reg NOT_rg_sfence_port0__read__3_4_AND_TASK_testpl_ETC___d41;
  reg NOT_rg_fence_port0__read__6_9_AND_NOT_rg_sfenc_ETC___d89;
  ...
  wire [63 : 0] nextpc__h1448,
		x_address__h2654,
		y_avValue__h1790,
		y_avValue_snd__h2044;
  wire [1 : 0] curr_epoch__h1378;
  ...
  assign rg_pc_port0__write_1 =
	     rg_sfence ? nextpc__h1448 : y_avValue_snd__h2044 ;
  ...
  assign curr_epoch__h1378 = { rg_eEpoch, rg_wEpoch } ;
  assign nextpc__h1448 = x_address__h2654 + 64'd4 ;
  assign x_address__h2654 = { rg_pc[63:2], 2'd0 } ;
  assign y_avValue__h1790 =
	     (bpu_mav_prediction_response[12] &&
	      (!bpu_mav_prediction_response[9] ||
	       bpu_mav_prediction_response[0])) ?
	       bpu_mav_prediction_response[76:13] :
	       nextpc__h1448 ;
  assign y_avValue_snd__h2044 =
	     rg_delayed_redirect[64] ?
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_gen_next_pc && !rg_sfence)
	begin
	  TASK_testplusargs___d37 = $test$plusargs("mstage0");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_gen_next_pc && !rg_sfence)
	begin
	  TASK_testplusargs___d38 = $test$plusargs("l0");
	  #0;
	end
    TASK_testplusargs_6_OR_TASK_testplusargs_7_AND_ETC___d44 =
	(TASK_testplusargs___d36 ||
	 TASK_testplusargs___d37 && TASK_testplusargs___d38) &&
	bpu_mav_prediction_response[10];
    TASK_testplusargs_6_OR_TASK_testplusargs_7_AND_ETC___d47 =
	(TASK_testplusargs___d36 ||
	 TASK_testplusargs___d37 && TASK_testplusargs___d38) &&
	!bpu_mav_prediction_response[10];
    TASK_testplusargs_6_OR_TASK_testplusargs_7_AND_ETC___d49 =
	(TASK_testplusargs___d36 ||
	 TASK_testplusargs___d37 && TASK_testplusargs___d38) &&
	bpu_mav_prediction_response[9];
	...
	(TASK_testplusargs___d36 ||
	 TASK_testplusargs___d37 && TASK_testplusargs___d38) &&
	!bpu_mav_prediction_response[9];
    TASK_testplusargs_6_OR_TASK_testplusargs_7_AND_ETC___d55 =
	(TASK_testplusargs___d36 ||
	 TASK_testplusargs___d37 && TASK_testplusargs___d38) &&
	bpu_mav_prediction_response[0];
    TASK_testplusargs_6_OR_TASK_testplusargs_7_AND_ETC___d57 =
	(TASK_testplusargs___d36 ||
	 TASK_testplusargs___d37 && TASK_testplusargs___d38) &&
	!bpu_mav_prediction_response[0];
    NOT_rg_sfence_port0__read__3_4_AND_TASK_testpl_ETC___d41 =
	!rg_sfence &&
	(TASK_testplusargs___d36 ||
	 TASK_testplusargs___d37 && TASK_testplusargs___d38);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    NOT_rg_fence_port0__read__6_9_AND_NOT_rg_sfenc_ETC___d89 =
	!rg_fence && !rg_sfence &&
