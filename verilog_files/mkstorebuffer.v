...
//
// On Fri Oct  9 13:15:11 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkstorebuffer(CLK,
  ...
  wire [63 : 0] _theResult____h1101,
		...
		y__h18253,
		y__h18512;
  wire [31 : 0] rg_atomic_readword_BITS_31_TO_0__q1, rs2571_BITS_31_TO_0__q2;
  wire [5 : 0] shiftamt__h18629, shiftamt__h2179;
  ...
  // actionvalue method mav_check_sb_hit
  assign mav_check_sb_hit = { x__h2169, x__h18316 } ;
  ...
  assign IF_rg_atomic_op_4_BIT_4_5_THEN_rg_atomic_readw_ETC___d48 =
	     op1__h1574 <= op2__h1575 ;
  assign IF_rg_atomic_op_4_BIT_4_5_THEN_rg_atomic_readw_ETC___d53 =
	     (op1__h1574 ^ 64'h8000000000000000) <=
	     (op2__h1575 ^ 64'h8000000000000000) ;
  ...
  assign _theResult____h1101 =
	     rg_atomic_op[4] ?
	       IF_rg_atomic_op_4_BITS_3_TO_0_6_EQ_0b11_7_THEN_ETC___d65 :
	       {2{IF_rg_atomic_op_4_BITS_3_TO_0_6_EQ_0b11_7_THEN_ETC___d65[31:0]}} ;
  assign n__h2654 = x__h2802 & y__h2803 ;
  assign op1___1__h1633 =
	     { {32{rg_atomic_readword_BITS_31_TO_0__q1[31]}},
	       rg_atomic_readword_BITS_31_TO_0__q1 } ;
  assign op1__h1574 = rg_atomic_op[4] ? rg_atomic_readword : op1___1__h1633 ;
  assign op2___1__h1634 =
	     { {32{rs2571_BITS_31_TO_0__q2[31]}}, rs2571_BITS_31_TO_0__q2 } ;
  assign op2__h1575 = rg_atomic_op[4] ? rs2__h1571 : op2___1__h1634 ;
  assign rg_atomic_readword_BITS_31_TO_0__q1 = rg_atomic_readword[31:0] ;
  assign rs2571_BITS_31_TO_0__q2 = rs2__h1571[31:0] ;
  assign shiftamt__h18629 = { ma_allocate_entry_address[2:0], 3'd0 } ;
  assign shiftamt__h2179 = { mav_check_sb_hit_phyaddr[2:0], 3'd0 } ;
  ...
  assign x__h18252 =
	     rg_tail ?
	       v_sb_meta_0_8_BITS_66_TO_3_7_AND_v_sb_meta_0_8_ETC___d152 :
	       n__h2654 ;
  assign x__h18316 = x__h18317 >> shiftamt__h2179 ;
  assign x__h18317 = x__h18511 | y__h18512 ;
  assign x__h18511 = x__h18252 & v_sb_meta_0[134:71] ;
  assign x__h20680 = temp__h18630 << shiftamt__h18629 ;
  assign x__h2169 = x__h2645 >> shiftamt__h2179 ;
  assign x__h2645 = x__h18252 | y__h18253 ;
  assign x__h2802 = ~x__h2804 ;
  assign x__h2806 = rg_tail - 1'd1 ;
  assign y__h18253 =
	     rg_tail ?
	       n__h2654 :
	       v_sb_meta_1_0_BITS_66_TO_3_8_AND_v_sb_meta_1_0_ETC___d187 ;
  assign y__h18512 = y__h18253 & v_sb_meta_1[134:71] ;
  always@(ma_allocate_entry_size or ma_allocate_entry_data)
  begin
    case (ma_allocate_entry_size)
      2'd0: x__h20754 = {8{ma_allocate_entry_data[7:0]}};
      2'd1: x__h20754 = {4{ma_allocate_entry_data[15:0]}};
      2'd2: x__h20754 = {2{ma_allocate_entry_data[31:0]}};
      2'd3: x__h20754 = ma_allocate_entry_data;
    endcase
  end
  always@(rg_head or v_sb_meta_0 or v_sb_meta_1)
  begin
    case (rg_head)
      1'd0: x__h21344 = v_sb_meta_0[134:71];
      1'd1: x__h21344 = v_sb_meta_1[134:71];
    endcase
  end
  always@(rg_head or v_sb_meta_0 or v_sb_meta_1)
  begin
    case (rg_head)
      1'd0: x__h21347 = v_sb_meta_0[66:3];
      1'd1: x__h21347 = v_sb_meta_1[66:3];
    endcase
  end
  always@(rg_atomic_tail or v_sb_meta_0 or v_sb_meta_1)
  begin
    case (rg_atomic_tail)
      1'd0: _s_addr__h1221 = v_sb_meta_0[166:135];
      1'd1: _s_addr__h1221 = v_sb_meta_1[166:135];
    endcase
  end
  always@(rg_atomic_tail or v_sb_meta_0 or v_sb_meta_1)
  begin
    case (rg_atomic_tail)
      1'd0: _s_epoch__h1222 = v_sb_meta_0[70];
      1'd1: _s_epoch__h1222 = v_sb_meta_1[70];
    endcase
  end
  always@(rg_atomic_tail or v_sb_meta_0 or v_sb_meta_1)
  begin
    case (rg_atomic_tail)
      1'd0: _s_fbindex__h1223 = v_sb_meta_0[69:67];
      1'd1: _s_fbindex__h1223 = v_sb_meta_1[69:67];
    endcase
  end
  always@(rg_atomic_tail or v_sb_meta_0 or v_sb_meta_1)
  begin
    case (rg_atomic_tail)
      1'd0: x__h1986 = v_sb_meta_0[66:3];
      1'd1: x__h1986 = v_sb_meta_1[66:3];
    endcase
  end
  always@(rg_atomic_tail or v_sb_meta_0 or v_sb_meta_1)
  begin
    case (rg_atomic_tail)
      1'd0: _s_size__h1226 = v_sb_meta_0[1:0];
      1'd1: _s_size__h1226 = v_sb_meta_1[1:0];
    endcase
  end
  always@(ma_allocate_entry_size)
  begin
    case (ma_allocate_entry_size)
      2'd0: temp__h18630 = 64'h00000000000000FF;
      2'd1: temp__h18630 = 64'h000000000000FFFF;
      2'd2: temp__h18630 = 64'h00000000FFFFFFFF;
      2'd3: temp__h18630 = 64'hFFFFFFFFFFFFFFFF;
    endcase
  end
  always@(rg_atomic_tail or v_sb_meta_0 or v_sb_meta_1)
  begin
    case (rg_atomic_tail)
      1'd0: rs2__h1571 = v_sb_meta_0[134:71];
      1'd1: rs2__h1571 = v_sb_meta_1[134:71];
    endcase
  end
